        ...
        <article className="mx-auto max-w-4xl">
          ...
          <div className="mb-12">
            <nav
              ...
              className="mb-5 flex flex-wrap items-center gap-2 font-mono text-sm uppercase font-bold text-black"
            >
            ...
            <Link
              ...
              className="group inline-flex items-center gap-2 border-2 border-black bg-white px-4 py-2 rounded-xl font-mono text-sm font-black uppercase text-black shadow-[3px_3px_0px_#000000] hover:bg-[#8e8ef7] transition-all active:translate-y-0.5"
            >
          ...
          <header className="mb-12 border-b-4 border-black pb-12">
            <div className="mb-6 flex flex-wrap items-center gap-3">
              <span className="border-2 border-black bg-[#8e8ef7] px-3 py-1 font-mono text-sm font-black uppercase text-black rounded shadow-[2px_2px_0px_#000000]">
            ...
            <p className="max-w-3xl font-mono text-[16px] sm:text-lg font-bold leading-relaxed text-black">
              {post.description}
            </p>
          </header>
          ...
          {isBeauty && (
            <p className="mb-12 rounded-2xl border-2 border-black bg-white p-4 font-mono text-sm font-bold leading-relaxed text-black shadow-[3px_3px_0px_#000000]">
          ...
          <div
            className="
              ...
              [&>p]:mb-6 [&>p]:text-[16px] [&>p]:sm:text-lg [&>p]:font-bold [&>p]:leading-relaxed [&>p]:text-black
              ...
              [&>ul]:mb-6 [&>ul]:list-disc [&>ul]:pl-6 [&>ul>li]:mb-2 [&>ul>li]:text-[16px] [&>ul>li]:sm:text-lg [&>ul>li]:font-bold [&>ul>li]:text-black
              [&>ol]:mb-6 [&>ol]:list-decimal [&>ol]:pl-6 [&>ol>li]:mb-2 [&>ol>li]:text-[16px] [&>ol>li]:sm:text-lg [&>ol>li]:font-bold [&>ol>li]:text-black
              ...
              [&>pre>code]:font-mono [&>pre>code]:text-sm [&>pre>code]:sm:text-[16px] [&>pre>code]:text-[#f7f3f1]
              [&>code]:rounded [&>code]:border [&>code]:border-black [&>code]:bg-[#8e8ef7]/20 [&>code]:px-1.5 [&>code]:py-0.5 [&>code]:font-mono [&>code]:text-sm [&>code]:font-black [&>code]:text-black
            "
          >
          ...
          <section className="mt-16 rounded-3xl border-4 border-black bg-white p-8 sm:p-12 shadow-[10px_10px_0px_#8e8ef7]">
            <div className="mb-4 inline-block border-2 border-black bg-black px-3 py-1 font-mono text-xs font-black uppercase tracking-widest text-white rounded">
            ...
            <p className="mb-8 max-w-2xl font-mono text-sm sm:text-[16px] font-bold leading-relaxed text-black">
              {isBeauty
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-xl border-2 border-black bg-[#8e8ef7] px-6 py-4 font-mono text-sm sm:text-[16px] font-black uppercase text-black shadow-[4px_4px_0px_#000000] transition-all hover:bg-black hover:text-[#f7f3f1] hover:shadow-none active:translate-y-1"
            >
          ...
          {relatedPosts.length > 0 && (
            <section className="relative mt-20 border-t-4 border-black pt-12">
              <div className="mb-8 flex items-end justify-between gap-6">
                <div>
                  <span className="font-mono text-sm font-black uppercase tracking-widest text-white bg-black px-2.5 py-0.5 rounded inline-block mb-2">
                    CONTINUE LENDO
                  </span>
                  <h2 className="font-title text-2xl sm:text-3xl font-black uppercase text-black">Artigos Relacionados</h2>
                </div>

                <span className="hidden font-mono text-sm font-black uppercase text-black md:block">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                {relatedPosts.map((relatedPost, index) => (
                  ...
                  >
                    <div>
                      <div className="mb-4 flex items-center justify-between font-mono text-sm font-black text-black">
                        <span className="text-white bg-black px-2 py-0.5 rounded text-xs">0{index + 1}</span>
                        <span>{formatDate(relatedPost.date)}</span>
                      </div>

                      <h3 className="font-title text-lg font-black uppercase leading-snug text-black group-hover:underline transition-colors mb-3">
                        <Link href={`/blog/${relatedPost.slug}`}>{relatedPost.title}</Link>
                      </h3>

                      <p className="line-clamp-3 font-mono text-sm font-bold leading-relaxed text-black">
                        {relatedPost.description}
                      </p>
                    </div>

                    <div className="mt-6 flex items-center justify-between border-t-2 border-black/10 pt-4 font-mono text-sm font-black uppercase text-black">
                      <Link
                        href={`/blog/${relatedPost.slug}`}
                        className="inline-flex items-center justify-between w-full group-hover:underline transition-colors"
                      >
