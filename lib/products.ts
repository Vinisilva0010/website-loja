...
export const products: Product[] = [
  ...
  {
    id: "mock-chapinha-1",
    name: "Escova Secadora Alisador Elétrica",
    description: "Elétrica Quente Cabelo Com 3 Em1 Hair Styler 110V",
    price: 43.9,
  ...
  {
    id: "mock-chapinha-1",
    name: "Removedor De Cravos Espinhas",
    description: "Cleaning Sugador Poros Acne Sucção Usb Recarregável",
    price: 23.9,
